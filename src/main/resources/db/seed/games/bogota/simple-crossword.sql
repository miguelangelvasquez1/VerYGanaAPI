...
SELECT
		 15,
    'Simple Crossword',
    'Completa el crucigrama respondiendo las pistas. Personaliza las palabras con vocabulario de tu marca.',
    'PATH',
    'simple-crossword',
    'https://games.verygana.com/game_icons/bogota/crucigrama.png',
     true, NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM games WHERE id = 15);
...
SELECT
  ...
  "properties": {
    ...
    "game": {
      "type": "object",
      "title": "Game Content",
      "description": "Word and clue entries that make up the game",
      "required": ["entries"],
      "properties": {
        "entries": {
          "type": "array",
          "title": "Entries",
          "description": "List of word-clue pairs the player must solve",
          "minItems": 1,
          "items": {
            "type": "object",
            "title": "Entry",
            ...
            "properties": {
              "word": {
                "type": "string",
                "title": "Word",
                "description": "The answer word the player must guess or find",
                "default": "",
                "minLength": 1,
                "maxLength": 64
              },
              "clue": {
                "type": "string",
                "title": "Clue",
                "description": "The hint or definition shown to the player for this word",
                "default": "",
                "minLength": 1,
                "maxLength": 512
              }
  ...
  "game": {
    ...
    "ui:description": "Define the word-clue pairs the player must solve",
    "entries": {
      "ui:title": "Word-Clue Entries",
      "ui:description": "Add one entry per word. Each word must have a corresponding clue.",
      "items": {
        "ui:order": ["word", "clue"],
        "word": {
          "ui:widget": "textInput",
          "ui:placeholder": "e.g. CHOCOLATE",
          "ui:help": "The answer word the player must guess or find"
        },
        "clue": {
          "ui:widget": "textInput",
          "ui:placeholder": "e.g. Dulce hecho de cacao",
          "ui:help": "The hint or definition shown to the player for this word"
        }
      }
    }
  },
