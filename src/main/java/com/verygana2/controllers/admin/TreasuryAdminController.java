...
public class TreasuryAdminController {
     ...
     *
     * GET /admin/treasury/KEYS_RESERVE/movements?page=0&size=20
     */
    @GetMapping("/movements/{code}")
    public ResponseEntity<PagedResponse<TreasuryMovementResponseDTO>> getMovements(
