...
public final class WordSearchAssets {
    ...
    static {
        ...
        words.add(MAPPER.createObjectNode().put("word", "GANAR").put("color", "#FF5722"));
        words.add(MAPPER.createObjectNode().put("word", "LLAVE").put("color", "#4CAF50"));
        words.add(MAPPER.createObjectNode().put("word", "FUTBOL").put("color", "#2196F3"));
        words.add(MAPPER.createObjectNode().put("word", "TENIS").put("color", "#FF5722"));
        words.add(MAPPER.createObjectNode().put("word", "MICRO").put("color", "#4CAF50"));
        words.add(MAPPER.createObjectNode().put("word", "TABLA").put("color", "#2196F3"));
        words.add(MAPPER.createObjectNode().put("word", "GASTO").put("color", "#FF5722"));
        words.add(MAPPER.createObjectNode().put("word", "MANSO").put("color", "#4CAF50"));
        words.add(MAPPER.createObjectNode().put("word", "GANSO").put("color", "#2196F3"));
        words.add(MAPPER.createObjectNode().put("word", "LEON").put("color", "#4CAF50"));
