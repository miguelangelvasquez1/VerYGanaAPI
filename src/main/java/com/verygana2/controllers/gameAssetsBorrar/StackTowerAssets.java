...
public final class StackTowerAssets {
    ...
    static {
        ...
        ArrayNode containerImages = MAPPER.createArrayNode();
        containerImages.add(MAPPER.createObjectNode().put("url", "https://games.verygana.com/asset_tests/redbull/redbull-logo.png"));
        containerImages.add(MAPPER.createObjectNode().put("url", "https://games.verygana.com/asset_tests/redbull/redbull-logo.png"));
        game.set("container_images", containerImages);
