...
public final class EndlessRunnerAssets {
    ...
    static {
        ...
        game.put("character_id", 2);

        ArrayNode woodSignPhrases = MAPPER.createArrayNode();
        woodSignPhrases.add("¡Sigue corriendo!").add("¡No mires atrás!").add("¡Vas muy bien!");
        game.set("wood_sign_phrases", woodSignPhrases);

        ArrayNode woodSignImages = MAPPER.createArrayNode();
        woodSignImages.add(MAPPER.createObjectNode().put("url", "https://games.verygana.com/asset_tests/redbull/redbull-logo.png"));
        woodSignImages.add(MAPPER.createObjectNode().put("url", "https://games.verygana.com/asset_tests/redbull/redbull-logo.png"));
        game.set("wood_sign_images", woodSignImages);

        game.put("key_spawn_probability", 0.12);
        root.set("game", game);
        ...
        texts.set("game_over_messages", MAPPER.createArrayNode().add("¡Sigue corriendo!"));
